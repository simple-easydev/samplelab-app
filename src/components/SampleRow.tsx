...
import { Crown, Play, Pause, Heart, Download, MoreVertical, X, Repeat, Loader2, Clock, Folder } from 'lucide-react';
...
import { SampleRowAction } from '@/components/SampleRowAction';
import {
  isSampleLiked,
  likeSample,
  unlikeSample,
