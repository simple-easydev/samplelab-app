/**
 * Genres filter bar – Figma 821-38780.
 * Sort options (Curated, A-Z) and search.
...
export interface GenresFilterBarProps {
  sortId: string;
...
export function GenresFilterBar({
  sortId,
  onSortIdChange,
  searchQuery,
  onSearchQueryChange,
